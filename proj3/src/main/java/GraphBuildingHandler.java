...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private GraphDB.Path curWay;

    private ArrayList<Long> nodesInCurWay = new ArrayList<>();
...
//            System.out.println("Node lat: " + attributes.getValue("lat"));
            ...
            curNode = new GraphDB.Node(Double.parseDouble(attributes.getValue("lon")),
            ...
            activeState = "way";
            curWay = new GraphDB.Path(Long.parseLong(attributes.getValue("id")));
            g.addWay(curWay);
            ...
            if (k.equals("maxspeed")) {
                ...
                if (ALLOWED_HIGHWAY_TYPES.contains(v)) {
                    for (int i = 0, j = 1; j < nodesInCurWay.size(); i++, j++) {
                        g.addEdge(nodesInCurWay.get(i), nodesInCurWay.get(j));
                    }
                    curWay.node = nodesInCurWay;
                }
